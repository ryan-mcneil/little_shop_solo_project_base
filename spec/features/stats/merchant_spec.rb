...
RSpec.describe 'Merchant Stats' do
  context 'as a merchant, viewing my dashboard' do
    before(:each) do
      ...
      @user_1 = create(:user)
      @address_1 = create(:address, user: @user_1, default_add: true, city: 'Denver', state: 'CO')
      @user_2 = create(:user)
      @address_2 = create(:address, user: @user_2, default_add: true, city: 'Los Angeles', state: 'CA')
      @user_3 = create(:user)
      @address_3 = create(:address, user: @user_3, default_add: true, city: 'Tampa', state: 'FL')
      @user_4 = create(:user)
      @address_4 = create(:address, user: @user_4, default_add: true, city: 'NYC', state: 'NY')
      ...
      @order_4 = create(:completed_order, user: @user_2, address: @address_2)
      create(:fulfilled_order_item, order: @order_4, item: @item_1)
      @order_5 = create(:completed_order, user: @user_2, address: @address_2)
      create(:fulfilled_order_item, order: @order_5, item: @item_1)
      @order_6 = create(:completed_order, user: @user_2, address: @address_2)
      create(:fulfilled_order_item, order: @order_6, item: @item_1)
      @order_7 = create(:completed_order, user: @user_2, address: @address_2)
      create(:fulfilled_order_item, order: @order_7, item: @item_1)
      # Sorry Tampa, Florida
      @order_8 = create(:completed_order, user: @user_3, address: @address_3)
      create(:fulfilled_order_item, order: @order_8, item: @item_1)
      # NYC, NY is 3rd place
      @order_9 = create(:completed_order, user: @user_4, address: @address_4)
      create(:fulfilled_order_item, order: @order_9, item: @item_1)
      @order_A = create(:completed_order, user: @user_4, address: @address_4)
    ...
    it 'shows total items I have sold and as a percentage of inventory' do
      ...
      order = create(:completed_order, address: @address_1)
